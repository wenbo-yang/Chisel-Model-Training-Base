...
class ModelTrainingTestController(ModelTrainingBaseController):
    def __init__(self, background_tasks_interface, config, model_training_model = None):
        super(ModelTrainingTestController, self).__init__(background_tasks_interface, config, model_training_model)
...
def test_wait_until_model_training_is_finished_get_model_should_return_model_path():
    ...
    model_training_test_controller = ModelTrainingTestController(fake_background_tasks, config)
    execution = model_training_test_controller.start_and_train_model()
